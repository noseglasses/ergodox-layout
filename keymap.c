 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Cut/S3|Cpy/S4|Pst/S5|Ctrl-F|Backsp|Shift |  M1  |Space | Alt  |  S1  |Ctrl-S/S2 | ESC  |
 * `-----------------------------------------------------------------------------------'
 */
  ...
  [M0] = FF_KEYMAP(
     ...
     LCTL(KC_X) ,LCTL(KC_C) ,LCTL(KC_V) ,LCTL(KC_F),KC_BSPACE,OSM(MOD_LSFT),OSL(M1)  ,KC_SPACE   ,OSM(MOD_LALT),XXXXXXXXXXX,LCTL(KC_S),KC_ESC
  ),
